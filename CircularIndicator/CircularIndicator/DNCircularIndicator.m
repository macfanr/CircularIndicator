...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    [[NSColor colorWithDeviceRed:0.5 green:0.5 blue:0.5 alpha:0.15] setStroke];
    [circlePath stroke];
    ...
    if(!self.indeterminate) {
        ...
        [clipPath addClip];
        [[NSColor colorWithDeviceRed:100/255.0 green:200/255.0 blue:247/255.0 alpha:1] setFill];
        [circlePath fill];
    }
    else {
